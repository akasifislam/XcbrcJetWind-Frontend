    ...
    >
      <div class="w-full flex flex-row items-center justify-between">
        <div class="text-3xl font-bold">
          <router-link to="/">
            <span class="sm:text-blue-600">Lara</span>
      ...
      <div
        class="mt-4 sm:mt-0 w-full sm:space-x-4 sm:text-right sm:block text-white"
...
<script>
import NavbarLink from "./Navbarlinks.vue";
import { userToggle } from "@/Composable/userToggle.js";
import { ref } from "vue";
export default {
  components: {
    NavbarLink,
